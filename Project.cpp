...
bool mrandkey(unsigned char* key, int keylen) {//Создание криптографиечески стойкого случайного ключа, используя генератор случайных чисел библиотеки OpenSSL. Обычные средства генерации случайных чисел в C++ могут быть предсказуемыми. Хотя для такого простого проекта это не так уж и важно
